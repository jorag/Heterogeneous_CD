...
from helperfuncs import _debug_print_bands, _shift_im, _default_load_options, _norm01
...
def _polmak_air05_air15_align_sub0(load_options=None):
    """ Load Polmak aerial photo 2005-2015 dataset. """
    print("Test Polmak aerial photo 2005-2015 dataset, qgis align UTM33N.")
    if not isinstance(load_options, dict):
        load_options = _default_load_options(load_options)
    ...
    if load_options["reduce"]:
        ...
        im = io.imread("data/Polmak/subset_0_of_air05-air15_qgis_align_UTM33N.tif")
...
def _polmak_air05_air10_align_sub0(load_options=None):
    """ Load Polmak aerial photo 2005-2010 dataset. """
    print("Test Polmak aerial photo 2005-2010 dataset, qgis align UTM33N.")
    if not isinstance(load_options, dict):
        load_options = _default_load_options(load_options)
...
def _polmak_air10_air15_align_sub0(load_options=None):
    """ Load Polmak aerial photo 2010-2015 dataset. """
    print("Test Polmak aerial photo 2010-2015 dataset, qgis align UTM33N.")
    if not isinstance(load_options, dict):
        load_options = _default_load_options(load_options)
...
def _polmak_air05_s2_align_sub0(load_options=None):
    """ Load Polmak aerial photo 2005-S2 dataset. """
    print("Test Polmak aerial photo 2005-S2 dataset, qgis align UTM33N.")
    if not isinstance(load_options, dict):
        load_options = _default_load_options(load_options)
    ...
    if load_options["reduce"]:
        ...
        im = io.imread("data/Polmak/subset_0_of_air2005-S2_qgis_align_UTM33N.tif")
        # Same changemap since years 05, 10, and 15 are in same .tif
        changemap = io.imread("data/Polmak/air05-s2_sub0-align-changemap.tif")
        t1 = np.array(im[:,:,10:13]) 
        t2 = np.array(im[:,:,0:10])
...
DATASETS = {
    ...
    "Polmak-Air05-Air15-align_sub0": _polmak_air05_air15_align_sub0,
